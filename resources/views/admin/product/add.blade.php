...
<div class="container">
<form style="width: 60%; margin:auto;padding:17px; box-shadow:0 0 2rem 0 rgb(136 152 170 / 15%); position:relative; margin-top:-88px; background-color:#fff;" method="POST" action="{{url('/admin/product/submit')}}" enctype="multipart/form-data">
    @csrf

    <div class="form-group">
      <label for="exampleFormControlInput1">Product Title</label>
      <input type="text" class="form-control" id="exampleFormControlInput1"  name="title" placeholder="Add Product Title" required>
    </div>
    <div class="form-group">
        <label for="exampleFormControlInput1">Slug</label>
        <input type="text" class="form-control" id="exampleFormControlInput1"  name="slug" placeholder="Add Slug" required>
    </div>
    <div class="form-group">
        <label for="exampleFormControlInput1">Product Description</label>
        <div id="editor" type="text" class="form-control" id="exampleFormControlInput1"  placeholder="Add Product Description"></div>
    ...
    <div class="form-group">
      ...
      <input type="number" class="form-control" id="exampleFormControlInput1"  name="stock" placeholder="Add Stock" required>
  </div>
  <div class="form-group">
    <label for="exampleFormControlInput1">Product Price</label>
    <input type="number" class="form-control" id="exampleFormControlInput1"  name="price" placeholder="Add Price" required>
  </div>
  <div class="form-group">
