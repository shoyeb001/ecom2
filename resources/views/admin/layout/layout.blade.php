      ...
      <div class="navbar-inner">
        ...
        <div class="collapse navbar-collapse" id="sidenav-collapse-main">
          ...
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
              <a class="nav-link" href="{{url('/admin/categories/list')}}">
                <i class="ni ni-bullet-list-67 text-primary"></i>
                <span class="nav-link-text">Categories</span>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="{{url('/admin/brands/list')}}">
                ...
                <div class="list-group list-group-flush">
                  <a href="#!" class="list-group-item list-group-item-action">
                    <div class="row align-items-center">
                      <div class="col-auto">
                       <?php
                        $data = DB::table('admin')->where('id',session('ADMIN_ID'))->get();
                        
                        ?>

                        <img alt="Image placeholder" src="{{asset('storage/product/'.$data[0]->photo)}}" class="avatar rounded-circle">
              ...
              <a class="nav-link pr-0" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <div class="media align-items-center">
                  <span class="avatar avatar-sm rounded-circle">
                    <img alt="Image placeholder"  src="{{asset('storage/admin/'.$data[0]->photo)}}">
                  </span>
                  <div class="media-body  ml-2  d-none d-lg-block">
                    <span class="mb-0 text-sm  font-weight-bold">{{$data[0]->name}}</span>
                  </div>
                </div>
              </a>
        ...
        <div class="row align-items-center justify-content-lg-between">
          <div class="col-lg-6">
            <div class="copyright text-center  text-lg-left  text-muted">
              &copy; 2021<a href="https://shoyeb001.github.io/protfolio.github.io/" class="font-weight-bold ml-1" target="_blank">Sk Shoyeb</a>
            </div>
          </div>
          <div class="col-lg-6">
            <ul class="nav nav-footer justify-content-center justify-content-lg-end">
              <li class="nav-item">
                <a href="http://devstacksolutions.c1.biz/" class="nav-link" target="_blank">Devstack Solution</a>
              </li>
            </ul>
          </div>
        </div>
